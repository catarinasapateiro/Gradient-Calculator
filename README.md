...
<div style="display: flex; gap: 40px; justify-content: center align-items:center;"> <img src="./screenshots/app_for_mobile.png" alt="Gradient Calculator App - Light Mode" width="45%"> <img src="./screenshots/app_for_mobile_darkmode.png" alt="App in Dark Mode" width="45%"> </div>
